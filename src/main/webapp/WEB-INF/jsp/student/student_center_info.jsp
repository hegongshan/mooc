	...
	<div class="row">
		<div class="col-md-3">
			<div class="list-group">
				...
				<a href="${pageContext.request.contextPath }/student/center/mycourse" class="list-group-item">我的课程<span class="fa fa-chevron-circle-right pull-right"></span></a>
			</div>
		</div>
		<div class="col-md-9">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="col-md-9">
						<form action="${pageContext.request.contextPath }/student/update_info" method="post" class="form-horizontal">
							<input type="hidden" value="${user.studentId }" name="studentId"/>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" value="${user.username }" name="email" class="form-control" placeholder="昵称"  disabled/>
								</div>
							</div>
							<div class="form-group">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="${pageContext.request.contextPath }/student/update_info" method="post" class="form-horizontal" enctype="multipart/form-data">
					<input type="hidden" value="${user.studentId }" name="studentId"/>
					<div class="form-group">
...
<div class="modal fade" id="updatePasswordDialog" tabindex="1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="${pageContext.request.contextPath }/student/updatepwd" method="post" class="form-horizontal" enctype="multipart/form-data">
